-- Active: 1749543480014@@127.0.0.1@3306@quiz
-- 1. 자료형 확인 문제
...
-- 정답: 사원 수 만큼의 id를 표현하는데 너무 큰 수는 필요하지 않아서
...
-- 정답: VARCHAR는 입력된 길이만큼의 공간만 차지하고, CHAR는 정해진 공간을 모두 차지한다
